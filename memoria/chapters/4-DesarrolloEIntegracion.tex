...
El Módulo 4 carga el escenario generado en formato JSON y ejecuta los algoritmos metaheurísticos bioinspirados de planificación de trayectorias (Colonia de Hormigas - ACO, Colonia de Abejas - ABC y Agujeros Negros - BHA), así como los baselines tradicionales de referencia (Búsqueda Voraz, Lawnmower y Expanding Spiral). Este módulo se integra sobre el núcleo de simulación de \textit{MTS-UncertainEnvironment} \cite{Broton_Gutierrez_MTS-UncertainEnvironment}.
