...
Los métodos metaheurísticos han demostrado ser efectivos para la planificación de rutas multi-UAV. Según revisiones de referencia sobre planificación de rutas y control de enjambres \cite{alqudsi2025, guo2025}, los algoritmos más utilizados incluyen:
...
Investigaciones consolidadas han propuesto enfoques avanzados de navegación autónoma con evasión de obstáculos basados en redes neuronales profundas para enjambres \cite{wang2025}, equilibrando explotación y exploración en entornos continuos.
...
Diversos trabajos han formulado la planificación de rutas UAV-SAR como POMDPs descentralizados para búsqueda y seguimiento activo de objetivos múltiples \cite{zhang2024}. Por su parte, la navegación autónoma con árboles de creencias adaptativas ha sido demostrada eficazmente para operaciones SAR en entornos con obstáculos y sin cobertura GPS \cite{sandino2020}.
