...
\begin{figure}[H]
	\ffigbox[\textwidth]
	{\caption{PROCESO DE FILTRADO DE RESTRICCIONES FÍSICAS EN LA CASA DE CAMPO: MAPA BASE NO FILTRADO (1), MÁSCARA BINARIA R-TREE (2), VISTA AÉREA SATELITAL DE REFERENCIA (3) Y MAPA DE CREENCIAS FINAL FILTRADO (4)}}
	{\label{fig:filtro_restricciones}
	\includegraphics[width=\textwidth]{imagenes/filtro_restricciones_demencia.png}}
\end{figure}
