...
\usepackage{caption} % Para el formato del caption
\usepackage{subcaption} % Para subfiguras
\usepackage{float} % Añade este paquete
\usepackage[babel, spanish=spanish]{csquotes}
\usepackage[ruled,vlined]{algorithm2e} % para crear algoritmos
...
% NOTA JOMPY: Crea los capítulos dentro de la carpeta chapter para ir organizando los contenidos te deojo un ejemplo
