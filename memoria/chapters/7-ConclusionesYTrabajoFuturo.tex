...
\begin{enumerate}
    ...
    En la formulación experimental se ha considerado un presupuesto de vuelo de $K = 1000$ pasos (equivalente a un recorrido total de entre $10{,}5$ y $12{,}4\text{ km}$ a una velocidad de crucero de $10\text{ m/s}$, con una duración de vuelo de entre $18$ y $25\text{ minutos}$, representativo del ciclo de descarga de una batería comercial SAR estándar tipo DJI Matrice 300/350 RTK o Mavic 3 Enterprise). Sin embargo, en el despliegue práctico en escenarios muy extensos como la Casa de Campo de Madrid ($17{,}2\text{ km}^2$), la cobertura completa de sectores distantes puede requerir misiones prolongadas que demanden la articulación de relevos continuos de baterías en el Puesto de Mando Avanzado (PMA) o el despliegue coordinado de múltiples aeronaves de forma simultánea.
\end{enumerate}
