...
from coordinates import NEDtoglobal


def to_plan_a(list_x, list_y, list_h, altitude_o, latitude_o, longitude_o, planName, radio, search_space_global_coords):
    """
    ...
    """
    #Dice NED pero está todo en ENU?
    try:
        print("Start to_plan")

        # Get the global coordinates in WGS84 system
        """print(type(list_x), type(list_y), type(list_h))
        print(list_x, list_y, list_h)"""
        longitudes, latitudes = NEDtoglobal(list_x, list_y, latitude_o, longitude_o)
        ...
        jsonf = {
            ...
            "geoFence": {
                ...
                "polygons": [
                    {
                        "inclusion": True,
                        "polygon": search_space_global_coords,
                        "version": 1,
                    }
                ],
                "version": 2,
            ...
            "mission": {
                ...
                "hoverSpeed": 5,
                "items": [],
                "plannedHomePosition": [list_x[0], list_y[0], altitude_o], # Se coge la primera posición de las listas para la posición inicial porque son la primera coordenada del vuelo del dron
                "vehicleType": 2,
                "version": 2,
            },
        ...
        #jsonf["geoFence"]["circles"][0]["circle"]["radius"] = max_distance + radio
