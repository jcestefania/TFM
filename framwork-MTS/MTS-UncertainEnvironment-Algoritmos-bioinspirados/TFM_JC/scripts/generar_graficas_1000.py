...
def main():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(out_dir, "comparativa_acierto_perfiles.png"), dpi=300)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(out_dir, "comparativa_likelihood_1000.png"), dpi=300)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(out_dir, "comparativa_area_1000.png"), dpi=300)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(out_dir, "comparativa_distancia_1000.png"), dpi=300)
    plt.close()
    
    # 5. Gráfica de Pasos hasta localización
    print("-> Generando gráfica de Pasos hasta localización...")
    fig, axes = plt.subplots(1, 3, figsize=(18, 6), sharey=True)
    for i, perfil in enumerate(perfiles):
        sub_df = df[df["Perfil"] == perfil]
        if sub_df.empty:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(out_dir, "comparativa_pasos_1000.png"), dpi=300)
    plt.close()
    
    print("¡Todas las gráficas de 1000 pasos se han generado correctamente!")
