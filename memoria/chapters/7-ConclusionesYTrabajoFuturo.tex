...
\begin{itemize}
    ...
    Incorporar matrices de transición dinámicas $P(x, y, t)$ orientadas por la pendiente del terreno, senderos y perfiles psicológicos de dispersión extraídos del Manual de Búsqueda y Salvamento Terrestre.
