...
Un caso de estudio fundamental que justifica la necesidad de este filtro surge en el **perfil Autista**. De acuerdo con las estadísticas oficiales del manual LPB \cite{koester2008lost}, los sujetos con autismo presentan una marcada tendencia a buscar refugio en estructuras cerradas ($45\%$) o a aproximarse a masas de agua ($9\%$), sumando un $54\%$ de la probabilidad estadística acumulada.
