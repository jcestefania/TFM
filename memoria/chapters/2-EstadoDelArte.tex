...
\begin{itemize}
	...
	\item \textbf{Ant Colony Optimization (ACO):} Ampliamente estudiado en la planificación de rutas multi-UAV para búsqueda en tiempo mínimo (MTS), donde variantes adaptadas al dominio continuo como $\text{ACO}_{\mathbb{R}}$ permiten optimizar trayectorias cinemáticas de vuelo sobre mapas de probabilidad bayesianos inciertos \cite{carabaza-ACOr, carabaza_ingles}.
\end{itemize}
