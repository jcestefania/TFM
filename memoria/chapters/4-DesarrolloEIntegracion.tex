...
\begin{figure}[H]
	\ffigbox[\textwidth]
	{\caption{INTERFAZ GRÁFICA DEL CUADERNO INTERACTIVO DE SIMULACIÓN Y CONTROL: PANEL DE CONFIGURACIÓN DE PERFILES LPB (SUPERIOR), SELECTOR DE ALGORITMOS MTS Y PRESUPUESTO DE VUELO (CENTRO), Y VISTA DUAL DE TRAYECTORIA, MAPA RESIDUAL Y CUADRO DE MÉTRICAS SAR (INFERIOR)}}
...
\begin{enumerate}
    ...
    \item \textbf{Control de Simulación (Panel Central):} Permite seleccionar el planificador inteligente deseado (ACO, ABC, BHA, Voraz, Lawnmower o Espiral), definir el presupuesto máximo de pasos de vuelo de la aeronave y fijar la semilla pseudoaleatoria de reproducibilidad antes de pulsar el botón de ejecución interactiva.
